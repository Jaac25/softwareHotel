...
public class ModificarHabitacion extends JPanel{
	...
	private void inicializar() {
		lblTitulo = new JLabel("Modificar Habitación");
	...
	private void caracteristicas() {
		...
		btnMirar.setActionCommand(Acciones.MIRAR_MODIFICAR_HABITACION);
		
		btnBuscar.setBounds(250,180,50,50);
		btnBuscar.setActionCommand(Acciones.BUSCAR_MODIFICAR_HABITACION);
		...
		btnModificar.setBounds(460,560,150,50);
		btnModificar.setActionCommand(Acciones.BTN_MODIFICAR_HABITACION);
	}	
