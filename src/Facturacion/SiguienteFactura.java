...
public class SiguienteFactura extends JPanel{
	...
	private void inicializar() {
		lblTitulo = new JLabel("Factura de la Reserva N°");
	...
	private void caracteristicas() {
		...
		lblTitulo.setBounds(120, 0, 460,50);
		txtReserva.setBounds(585,0,100,50);
		...
		btnAtras.setActionCommand(Acciones.ATRAS_SIGUIENTE);
		
		btnCobrar.setFont(new Font("Algerian", 0, 20));
		btnCobrar.setBackground(Color.BLACK);
		btnCobrar.setForeground(Color.WHITE);
		btnCobrar.setBounds(460,500,150,70);
		btnCobrar.setActionCommand(Acciones.GUARDAR_FACTURA);
	}
