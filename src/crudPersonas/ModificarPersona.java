...
public class ModificarPersona extends JPanel{
	...
	private void caracteristicas() {
		...
		btnBuscar.setActionCommand(Acciones.BUSCAR_MODIFICAR_PERSONA);
		...
		btnModificar.setActionCommand(Acciones.BTN_MODIFICAR_PERSONA);
	}
	...
	public void setBtnModificar(JButton btnGuardar) {
		this.btnModificar = btnGuardar;
	}
