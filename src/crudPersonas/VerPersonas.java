...
public class VerPersonas extends JPanel{
	...
	private void inicializar() {
		lblTitulo = new JLabel("Ver Clientes");
		String[] cabecera = {"Documento","Nombre","Ciudad","Celular","F. Nacimiento","Usuario","Contraseña"};
